...
export default function BlogDetail() {
    return (
        <TheLayOut>
            <div className=" py-10 font-font01 px-5">
                ...
                <div className="container mx-auto">
                    <div className="mt-3 md:mt-24 grid grid-cols-1 lg:grid-cols-4 gap-4">
                        <div className=" col-span-2 md:col-span-3">
                            <img className="mx-auto" src="https://miro.medium.com/v2/resize:fit:720/format:webp/1*76Qb1fvqzkgSM30lfoFDRQ.jpeg" alt="" />

                            <article className="prose lg:prose-xl mt-8 whitespace-normal lg:text-justify px-5">
                                ...
                                <h3 className="">Recommended 6 step approach to conducting a UX audit</h3>
                            ...
                            <div className="w-full mt-10 h-1 bg-black rounded-full mb-4 hidden md:block lg:hidden"></div>
                        </div>

                        <div className="bg-purple-900/10 md:bg-inherit lg:bg-purple-900/10 mx-auto px-5 py-4 rounded-md">
                            <p className="text-black">บทความที่เกี่ยวข้อง</p>
                            <div className="flex flex-col md:flex-row lg:flex-col justify-start items-center gap-6 mt-10" >
                                <Card className="mt-6 w-52 lg:w-64 p-3">
                                    ...
                                    <CardFooter className="p-1 text-right">
                                        <Link href="blogDetail">
                                            <Button className=" bg-purple-400 rounded-full hover:bg-sky-500 text-sm font-font01 p-3">อ่านเพิ่ม</Button>
                                        </Link>
                                    </CardFooter>
                                </Card>
                                <Card className="mt-6 w-52 lg:w-64 p-3">
